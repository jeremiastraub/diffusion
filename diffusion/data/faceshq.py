...
from diffusion.data.base import ImagePaths, NumpyPaths, ConcatDatasetWithIndex

# -----------------------------------------------------------------------------

BASE_PATH_CelebAHQ = "data/celebahq"
BASE_PATH_FFHQ = "data/ffhq"
...
class FFHQTrain(FacesBase):
    ...
    def __init__(self, size, keys=None, random_flip=True):
        ...
        self.data = ImagePaths(
            paths=paths, size=size, random_crop=False, random_flip=random_flip
        )
        self.keys = keys
